...
//  const { name } = useParams();
  ...
  const [selectedPair, setSelectedPair] = useState([match.params.pair])
        ...
        <div id="order-form-nav">
          <ul className="nav nav-pills spaced20 mini dark vmarg30bot">
            <li className="margin-left-20" onClick={() => {
              ...
              <a id="order-simple" className={navbarOrder[0]}
              >
                Simple </a>
            </li>
            <li className="margin-left-20" onClick={() => {
              ...
              <a id="order-int" className={navbarOrder[1]}>
                Intermediate </a>
            </li>
            <li className="margin-left-20" onClick={() => {
              _showOrder("order-adv")
            }}>
              <a id="order-adv" className={navbarOrder[2]}>
                Advanced </a>
            </li>
          </ul>
        </div>

        <form className="form-order form-order-simple jq-validate-form vmarg5top" method="post" autoComplete="off"
                  ...
                  <div className="ib posrel">
                    <div className="dropdown">
                      <a title="" data-value="XXBT"
                         className="btn add-on volume-currency-toggle dropdown-toggle tt" data-toggle="dropdown"
                         data-original-title="Click to switch amount currency.">
                        XBT <span className="caret"></span>
                      </a>
                ...
                <div className="ib">
                  <div className="input-append">
                    <input type="text" placeholder="Price" tabIndex="2" className="input-small ralign hmarg0right"
                           value="" name="price" autoComplete="off" /><span className="add-on pair hmarg20right">EUR</span>
                  </div>
                </div>
                <div className="ib ordertype-wrap">
                  <div className="btn-group" data-toggle="buttons-radio" name="ordertype">
                    <button type="button" className="btn btn-small" value="market" autoComplete="off">Market</button>
                    <button type="button" className="btn btn-small active" value="limit" autoComplete="off">Limit
                    </button>
                  </div>
                </div>
                <p className="control-hint" name="ordertype-hint">Buy at a fixed price per XBT.</p>
              </div>
                          ...
                          <div className="control-group">
                            ...
                            <div className="controls">
                              <div className="pricetype-wrap">
                                ...
                                <div className="ib hmarg5right">
                                  <div className="input-append">
                                    <input type="text" className="span2 ralign hmarg0 price" value="" name="price"
                        ...
                        <div className="control-group">
                          ...
                          <div className="controls">
                            <div className="pricetype-wrap">
                              ...
                              <div className="ib hmarg5right">
                                <div className="input-append">
                                  <input type="text" disabled="disabled" className="span2 ralign hmarg0 price" value=""
                        ...
                        <div className="control-group price2wrap hidden2">
                          ...
                          <div className="controls">
                            <div className="pricetype-wrap">
                              ...
                              <div className="ib hmarg5right">
                                <div className="input-append">
                                  <input type="text" disabled="disabled" className="span2 ralign hmarg0 price2" value=""
